...
class BloodPotionForm extends SimpleForm
{
    ...
    public function __construct(Player $player)
    {
        ...
        parent::__construct(function (Player $player, $data) use ($config) {
            ...
            switch ($result) {
                case 0:
                    $amount = $config->get("Blood_Potion_Price");
        ...
        $this->setTitle("§l§bPURCHASE BLOOD POTION?");
        $this->setContent("§dName: §fBlood Potion\n\n§dDescription: §fConsume This Potion To Receive All Effects For 2 Days.\n\n§dDuration: §f2 Days\n\n§dPrice §f" . $config->get("Blood_Potion_Price"));
